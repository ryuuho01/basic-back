...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param = [
            ...
            'pic_path' => 'https://advance-backet.s3.ap-northeast-1.amazonaws.com/yakiniku.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 394,
            ...
            'pic_path' => 'https://advance-backet.s3.ap-northeast-1.amazonaws.com/izakaya.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 124,
        ...
        $param = [
            ...
            'pic_path' => 'https://advance-backet.s3.ap-northeast-1.amazonaws.com/ramen.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 124,
