...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'pic_path' => 'https://afternoon-beyond-97179.herokuapp.com/storage/sushi.jpeg',
        ];
        ...
        $param = [
            ...
            'pic_path' => 'https://afternoon-beyond-97179.herokuapp.com/storage/yakiniku.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 394,
            ...
            'pic_path' => 'https://afternoon-beyond-97179.herokuapp.com/storage/izakaya.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 124,
            ...
            'pic_path' => 'https://afternoon-beyond-97179.herokuapp.com/storage/italian.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 394,
            ...
            'pic_path' => 'https://afternoon-beyond-97179.herokuapp.com/storage/ramen.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 124,
